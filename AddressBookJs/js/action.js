...
//		data[cnt] = obj;
//
//		// Create an empty <tr> element and add it to the 1st position of the
//		// table:
...
//
//		add(row.insertCell(4), "button", "Edit", "Edit('edit_" + (this.cnt)
//				+ "')", "edit_" + (cnt));
//		add(row.insertCell(5), "button", "Delete", "Delete('delete_"
//				+ (this.cnt) + "')", "delete_" + (cnt));
//
...
//			.setAttribute("src", "" + data[pos].image);
//}
//
//function Delete(pos) {
//	if (cnt > 0) {
...
//		row.insertCell(3).innerHTML = "" + address;
//
//		add(row.insertCell(4), "button", "Edit",
//				"Edit('edit_" + (i - 1) + "')", "edit_" + (i - 1));
//		add(row.insertCell(5), "button", "Delete", "Delete('delete_" + (i - 1)
//				+ "')", "delete_" + (i - 1));
//
//		document.getElementById("profile").setAttribute("src",
//				"images/" + image);
//	}
//}
//
